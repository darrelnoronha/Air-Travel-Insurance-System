      ...
      <form action="success1.php" method="post" id="f" onsubmit="return validateForm()">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="fname" name="firstname" placeholder="Gibson T" required>
            <label for="email"><i class="fa fa-envelope"></i> Email</label>
            <input type="email" id="email" name="email" placeholder="gibs@gmail.com" required>
          ...
          <div class="col-50">
            ...
            <input type="text" id="cname" name="cardname" placeholder="Gibson Tauro" required>
